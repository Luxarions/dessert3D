...
class Vec4 {
  ...
  setAxisAngleFromRotationMatrix(m) {
    ...
    if ((Math.abs(m12 - m21) < 0.01) && (Math.abs(m13 - m31) < 0.01) && (Math.abs(m23 - m32) < 0.01)) {
      ...
      if ((xx > yy) && (xx > zz)) {
        if (xx < 0.001) {
          x = 0; y = 0.7071067811865475244; z = 0.7071067811865475244;
        } else {
          x = Math.sqrt(xx); y = xy / x; z = xz / x;
        }
      } else if (yy > zz) {
        if (yy < 0.001) {
          x = 0.7071067811865475244; y = 0; z = 0.7071067811865475244;
        } else {
          y = Math.sqrt(yy); x = xy / y; z = yz / y;
        }
      } else {
        if (zz < 0.001) {
          x = 0.7071067811865475244; y = 0.7071067811865475244; z = 0;
        } else {
